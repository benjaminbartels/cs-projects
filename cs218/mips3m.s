...
secondWhileLoop:
	...
	outerForLoop:
		...
		# var tmp = lst[i]
		mulou	$t0, $t2, 4			# t0 = offset = i * 4
		addu	$t0, $a0, $t0			# t0 = 1st address + offset
		...
		innerForLoop:
			...
			subu	$t9, $t3, $t1			# t9 = j - h
			mulou	$t9, $t9, 4			# t9 = offset = (j - h) * 4
			addu	$t9, $a0, $t9			# t9 = 1st address + offset
			lw	$t9, ($t9)			# t9 = value of list[j - h]
			bge	$t9, $t4, innerForLoopDone

			# else continue inner for loop
			
			# lst[j] = lst[j - h]
	
			mulou	$t8, $t3, 4			# t8 = offset = j * 4
			addu	$t8, $a0, $t8			# t8 = 1st address + offset
		...
		# lst[j] = tmp	
		mulou	$t7, $t3, 4			# t7 = offset = j * 4
		addu	$t7, $a0, $t7			# t8 = 1st address + offset
